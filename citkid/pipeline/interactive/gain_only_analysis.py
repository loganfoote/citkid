...
::
    ...
    from citkid.pipeline.interactive.gain_only_analysis import run_gain_only_analysis
...
def run_gain_only_analysis(AR, start_idx=0, data_idxs=None,
    ...
    title (str): Window title. Default 'Gain Analysis'.
    ...
    """
    return run_interactive(AR, panels=_GAIN_ONLY_PANELS, start_idx=start_idx,
